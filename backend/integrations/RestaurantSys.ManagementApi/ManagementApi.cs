...
namespace RestaurantSys.Api
{
    ...
    ";
            ...
            /* ========== MANAGMENT SETTINGS MAP ========== */

            /* GET current settings (auto-create default row if missing) */
    ...
    ";
            ...
            /* PUT update settings (partial update allowed) */
    ...
    ";
            ...
            /* (Optional) a tiny helper if you only need the number quickly */
